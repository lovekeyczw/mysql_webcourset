...
<table class="datalist" width="100%" border="1" style="text-align:center">
  ...
  <?php 
  $sql="select * from course where cno not in(select cno from sc where sno='".$_SESSION["user"]."')";
 ...
 do{
  ...
  <tr>
   ...
   <!--   <td><?php //echo $info["jieshao"];?></td>--> 
    <td><a href="<?php echo "adminsavecourse.php?action=add&cnot=".$info["cno"]?>">选修</a></td>
  </tr>
  <?php
